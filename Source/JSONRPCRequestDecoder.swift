...
/// compiler.
public extension JSONRPCRequestDecodable {
    public init(fromJSONRPC decoder: JSONRPCRequestDecoder) throws {
        try self.init(from: decoder)
    }
}

/// The actual JSONRPC Request decoder class.
public class JSONRPCRequestDecoder {
...
public extension JSONRPCRequestDecoder {
    static func decode<T: JSONRPCRequestDecodable>(_ type: T.Type, data: [UInt8]) throws -> T {
...
public extension JSONRPCRequestDecoder {
    ...
    func decode<T: Decodable>(_ type: T.Type) throws -> T {
        ...
        case let intT as FixedWidthInteger.Type:
            return try intT.from(jsonrpcRequestDecoder: self) as! T
        ...
        case let binaryT as JSONRPCRequestDecodable.Type:
...
private extension JSONRPCRequestDecoder {
...
private extension FixedWidthInteger {
    static func from(jsonrpcRequestDecoder: JSONRPCRequestDecoder) throws -> Self {
        var v = Self.init()
        try jsonrpcRequestDecoder.read(into: &v)
